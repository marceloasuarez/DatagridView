...
.then(res=>{
	...
	res.forEach(el => {
		...
		imgDelete.addEventListener("click",(evt)=>{
			const id=evt.target.parentNode.parentNode.firstChild.innerHTML; //aca sube 2 divs pai y luego baja al primer filho para pegar el ID
...
//			const produto=document.querySelector("#f_produto").value;
//			const marca=document.querySelector("#f_marca").value;
//			const modelo=document.querySelector("#f_modelo").value;
